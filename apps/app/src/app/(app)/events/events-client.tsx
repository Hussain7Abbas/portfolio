...
export function EventsClient() {
  ...
  async function load() {
    ...
    try {
      ...
      setLoadError(e instanceof ApiError ? e.message : "Failed to load events");
    } finally {
      setLoading(false);
    }
  }
  ...
  async function add(e: React.FormEvent) {
    ...
    try {
      ...
      toast.error(err instanceof ApiError ? err.message : "Failed to add event");
    } finally {
      setAdding(false);
    }
  }
  ...
  async function saveEdit(e: React.FormEvent) {
    ...
    setSavingEdit(true);
    try {
      await apiJson(`/api/events/${editingId}`, {
        method: "PUT",
  ...
  async function remove(row: Row) {
    ...
    try {
      ...
      if (!res.ok) {
        throw new Error((await res.text()) || "Failed to delete event");
      }
